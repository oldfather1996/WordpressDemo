...
Themebase_Kirki::add_field( 'theme', array(
	...
	'section'  => $section,
	'priority' => $priority ++,
	'default'  => '<div class="desc"><strong class="insight-label insight-label-info">' . esc_html__( 'IMPORTANT NOTE: ', 'themebase' ) . '</strong>' . esc_html__( 'This section contains general demo options. Additional demo options for specific areas can be found within other sections. Example: For breadcrumb demo options go to the breadcrumb section.', 'themebase' ) . '</div>',
) );
/*--------------------------------------------------------------
# Body demo
--------------------------------------------------------------*/
Themebase_Kirki::add_field( 'theme', array(
	...
	'section'  => $section,
	'priority' => $priority ++,
	'default'  => '<div class="big_title">' . esc_html__( 'Body demo', 'themebase' ) . '</div>',
) );
Themebase_Kirki::add_field( 'theme', array(
	'type'        => 'demo',
	'settings'    => $prefix . 'body',
	'label'       => esc_html__( 'Font family', 'themebase' ),
	'description' => esc_html__( 'These settings control the demo for all body text.', 'themebase' ),
	'section'     => $section,
	'priority'    => $priority ++,
	'transport'   => 'auto',
	'default'     => array(
...
Themebase_Kirki::add_field( 'theme', array(
	...
	'section'  => $section,
	'priority' => $priority ++,
	'default'  => '<div class="big_title">' . esc_html__( 'Heading demo', 'themebase' ) . '</div>',
) );
Themebase_Kirki::add_field( 'theme', array(
	'type'        => 'demo',
	'settings'    => $prefix . 'heading',
	'label'       => esc_html__( 'Font family', 'themebase' ),
	'description' => esc_html__( 'These settings control the demo for all heading text.', 'themebase' ),
	'section'     => $section,
	'priority'    => $priority ++,
	'transport'   => 'auto',
	'default'     => array(
